...
@Component({
  selector: 'app-carrito-negocio',
  templateUrl: './carrito-negocio.page.html',
  styleUrls: ['./carrito-negocio.page.scss'],
})
export class CarritoNegocioPage implements OnInit {
        ...
        },
        {
          ...
          handler: async () => {
            ...
            if (index > -1) {
              ...
              try {
                await this.firebaseSvc.deleteDocumet(`users/${userId}/carrito_negocio/${carritoId}/detalle_carrito/${detalleCarritoId}`);
  ...
  async continuePurchase() {
    ...
    if (!direccion || direccion.length === 0) {
      ...
      this.utilsSvc.routerLink('/main/metodo-entrega-negocio');
    }
  }
