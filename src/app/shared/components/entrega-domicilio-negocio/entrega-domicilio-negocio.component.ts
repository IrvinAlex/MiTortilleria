...
@Component({
  selector: 'app-entrega-domicilio-negocio',
  templateUrl: './entrega-domicilio-negocio.component.html',
  styleUrls: ['./entrega-domicilio-negocio.component.scss'],
})
export class EntregaDomicilioNegocioComponent  implements OnInit {
          ...
          return actions.order.capture().then(async (details) => {
            ...
            setTimeout(async () => {
              ...
              const pedido = {
                ...
                uid_cliente: userId,
                geopoint_entrega: {
                  latitude: direccionEntrega.geopoint._lat,
                  longitude: direccionEntrega.geopoint._long
                }
              };
              ...
              // Eliminar elementos del carrito en Firebase - with validation
              ...
              if (carritoId) {
                ...
                console.warn('Cart ID is missing, skipping cart item deletion');
              }
  ...
  async getCartDetails() {
    ...
    const cartData = this.utilsSvc.getFromLocalStorage('carrito_negocio');
